...
<div class="container mt-4">
  <div class="row">
    <div class="col-12">
      <h3 class="text-center text-primary text-decoration-underline mb-4">MRTP_Tax_Act</h3>
...
main_url = "https://arksandassociates.com/laws/8241/Monopolies_and_Restrictive_Trade_Practices_Act_1969.aspx"
...
def modify_tbody(tbody):
    soup = BeautifulSoup(str(tbody), 'html.parser')
    rows = soup.find_all('a')
    
    # Start href increment from 1
    href_value = 1
    for row in rows:
        row['href'] = str(href_value)
        href_value += 1
...
if tbody:
    # Modify the tbody with incremental href values
    modified_tbody = modify_tbody(tbody)
    
    # Create the index.html file and write the content
    with open('index.html', 'w') as file:
        file.write(header)  # Write header
        file.write(modified_tbody)  # Write modified tbody
        file.write(footer)  # Write footer

    print("index.html file has been created successfully!")
else:
    print("Could not find the tbody section in the page.")