...
<div class="container mt-4">
  <div class="row">
    <div class="col-12">
      <h3 class="text-center text-primary text-decoration-underline mb-4">GST_Tax_Act</h3>
...
main_url = "https://arksandassociates.com/laws/10573/GST_Compensation_to_States_Act_2017.aspx"
