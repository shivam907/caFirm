...
<div class="container mt-4">
  <div class="row">
    <div class="col-12">
      <h3 class="text-center text-primary text-decoration-underline mb-4">Equalization_Tax_Act</h3>
...
main_url = "https://arksandassociates.com/laws/1350/Right_To_Information_Act,_2005.aspx"
