...
function removeElement() {
    ...
    const element = document.querySelector('.d-flex.justify-content-end');
    const el=document.querySelector('header')
    // el.remove()
    // Check if the element exists and matches the exact structure
    if (element && 
        element.innerHTML.trim() === `
          <label for="sectionId" class="form-label me-2">Section / Rule Number</label>
          <input type="text" id="sectionId" class="form-control form-control-sm me-3" style="width: 15%;">
          
          <label for="contentId" class="form-label me-2">Content</label>
          <input type="text" id="contentId" class="form-control form-control-sm me-3" style="width: 15%;">
        ...
        console.log("Element not found or does not match the exact structure.");
    }
}
